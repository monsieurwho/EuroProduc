...
client.on("guildMemberAdd", member => {
    member.guild.channels.find("name", "🔔bienvenue").send(`Bienvenue ${member} sur **Europium**`)
...
client.on("guildMemberRemove", member => {
    member.guild.channels.find("name", "🔔bienvenue").send(`A bientôt ${member} sur **Europium**`)
});
